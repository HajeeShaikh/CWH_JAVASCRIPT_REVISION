...
// To calculate P1 contribution

let P1Contribution;

const Fauzan = ( ...amounts ) =>
{

  P1Contribution = amounts.reduce( ( a, b ) =>
  {
    return a + b
  }, 0 )
...
let amounts1 = []
while ( !amounts1.includes( 0 ) )
{
  let Fauzan = prompt( "Enter contribution of Fauzan =====> : " )
  Fauzan = Number.parseInt( Fauzan )
  amounts1.push( Fauzan )
}
Fauzan( ...amounts1 );

console.log( "\n" );

// To calculate P2 contribution

let P2Contribution;

const Altamash = ( ...amounts ) =>
{
  P2Contribution = amounts.reduce( ( a, b ) =>
  {
    return a + b
  }, 0 )
...
let amounts2 = []
while ( !amounts2.includes( 0 ) )
{
  let Altamash = prompt( "Enter contribution of Altamash =====> : " )
  Altamash = Number.parseInt( Altamash )
  amounts2.push( Altamash )
}
Altamash( ...amounts2 );

console.log( "\n" );

// To calculate P3 contribution

let P3Contribution;

const Shoaib = ( ...amounts ) =>
{
  P3Contribution = amounts.reduce( ( a, b ) =>
  {
    return a + b
  }, 0 )
}
...
while ( !amounts3.includes( 0 ) )
{
  let Shoaib = prompt( "Enter contribution of Shoaib =====> : " )
  Shoaib = Number.parseInt( Shoaib )
  amounts3.push( Shoaib )
}

Shoaib( ...amounts3 )
console.log( "\n" );

// To calculate P4 contribution

let P4Contribution;

const Rafiq = ( ...amounts ) =>
{
  P4Contribution = amounts.reduce( ( a, b ) =>
  {
    return a + b
  }, 0 )
}
...
while ( !amounts4.includes( 0 ) )
{
  let Rafiq = prompt( "Enter contribution of Rafiq =====> : " )
  Rafiq = Number.parseInt( Rafiq )
  amounts4.push( Rafiq )
}
...
const Hajee = ( ...amounts ) =>
{
  P5Contribution = amounts.reduce( ( a, b ) =>
  {
    return a + b
  }, 0 )
}
...
while ( !amounts5.includes( 0 ) )
{
  let Hajee = prompt( "Enter contribution of Hajee =====> : " )
  Hajee = Number.parseInt( Hajee )
  amounts5.push( Hajee )
}
